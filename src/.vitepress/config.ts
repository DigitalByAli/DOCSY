	...
	themeConfig: {
		...
		sidebar: [
			...
			},
			{
				...
				items: [
					{ text: 'Toast', link: '/interact/toast' },
					{ text: 'Confirm', link: '/interact/confirm' },
					{ text: 'Prompt', link: '/interact/prompt' },
					{ text: 'Navigate', link: '/interact/navigate' },
					{ text: 'Download', link: '/interact/download' },
				],
			},
		],
	},
